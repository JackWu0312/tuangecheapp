...
class Modifyphonenew extends StatefulWidget {
  final Map arguments;
  Modifyphonenew({Key key, this.arguments}) : super(key: key);
  @override
  _ModifyphonenewState createState() => _ModifyphonenewState();
}

class _ModifyphonenewState extends State<Modifyphonenew> {
  @override
  Timer timer;
  String _text = '获取验证码';
  ...
  submit() {
    HttpUtlis.post("wx/auth/verifyCode",
        params: {'mobile': widget.arguments['mobile'], 'code': code},
        success: (value) async {
      if (value['errno'] == 0) {
